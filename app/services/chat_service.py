...
Equivalent to WebUI's Chats table operations
"""
import uuid
import time
import logging
...
from app.models.chat_models import (
    Chat, Tag,ChatModel, ChatTitleIdResponse, ChatForm, ChatImportForm,ChatListResponse, TagModel)
...
class ChatService:
    ...
    def insert_new_chat(self,user_id: str,form_data: ChatForm,db: Session) -> Optional[ChatModel]:
        """Create a new chat"""
        try:
    ...
    def import_chats(self,user_id: str,chat_import_forms: List[ChatImportForm],db: Session) -> List[ChatModel]:
    ...
    def get_chat_by_id(self,chat_id: str,db: Session) -> Optional[ChatModel]:
        """Get a chat by ID"""
        try:
    ...
    def get_chat_by_id_and_user_id(self,chat_id: str,user_id: str,db: Session) -> Optional[ChatModel]:
    ...
    def get_chats_by_user_id(self,user_id: str,skip: Optional[int] = None,limit: Optional[int] = None,db: Session = None) -> ChatListResponse:
    ...
    def get_pinned_chats_by_user_id(self,user_id: str,db: Session) -> List[ChatModel]:
    ...
    def get_archived_chats_by_user_id(self,user_id: str,skip: int = 0,limit: int = 60,db: Session = None) -> List[ChatModel]:
    ...
    def search_chats(self,user_id: str,search_text: str,skip: int = 0,limit: int = 60,db: Session = None) -> List[ChatTitleIdResponse]:
    ...
    def toggle_chat_pinned_by_id(self,chat_id: str,db: Session) -> Optional[ChatModel]:
    ...
    def toggle_chat_archive_by_id(self,chat_id: str,db: Session) -> Optional[ChatModel]:
    ...
    def update_chat_folder_id(self,chat_id: str,user_id: str,folder_id: Optional[str],db: Session) -> Optional[ChatModel]:
    ...
    def upsert_message_to_chat(self,chat_id: str,message_id: str,message: Dict[str, Any],db: Session) -> Optional[ChatModel]:
    ...
    def delete_chat_by_id(self,chat_id: str,db: Session) -> bool:
        """Delete a chat by ID"""
        try:
    ...
    def delete_chat_by_id_and_user_id(self,chat_id: str,user_id: str,db: Session) -> bool:
    ...
    def delete_all_chats_by_user_id(self,user_id: str,db: Session) -> bool:
    ...
    def archive_all_chats_by_user_id(self,user_id: str,db: Session) -> bool:
    ...
    def add_chat_tag(self,chat_id: str, user_id: str,tag_name: str,db: Session) -> Optional[ChatModel]:
        """Add a tag to a chat"""
        try:
    ...
    def remove_chat_tag(self,chat_id: str,user_id: str,tag_name: str,db: Session) -> bool:
    ...
    def get_user_tags(self,user_id: str,db: Session) -> List[TagModel]:
