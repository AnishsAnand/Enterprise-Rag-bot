# API Specification: jenkins - list
...
## Endpoint
- **Method:** POST
- **URL:** {BASE_URL_PAAS_SERVICE}/api/v1/paas/listManagedServices/IKSJenkins
...
## Workflow Steps
### Workflow: list_jenkins
List Jenkins services across endpoints
